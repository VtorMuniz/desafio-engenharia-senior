...
- **CI/CD Automatizado:** A esteira contaria com GitHub Actions ou Azure DevOps rodando os testes automatizados a cada *Pull Request* para a branch `develop`, além de realizar o *deploy* dos pipelines e notebooks nos *workspaces* (Dev, QA, Prod).